...
<TD><a
	href="${pageContext.request.contextPath }/linkman_showLinkMan.action?linkid=${linkman.linkid}">修改</a>
	&nbsp;&nbsp; <a
	href="${pageContext.request.contextPath }/linkman_delete.action?linkid=${linkman.linkid}">删除</a>
</TD>
	</TR>
